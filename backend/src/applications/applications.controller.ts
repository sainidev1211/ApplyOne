...
export class ApplicationsController {
  ...
  assignEmployee(@Request() req: any, @Param('id') id: string, @Body() assignDto: AssignEmployeeDto) {
  ...
  updateStatus(@Request() req: any, @Param('id') id: string, @Body() statusDto: UpdateStatusDto) {
  ...
  addNote(@Request() req: any, @Param('id') id: string, @Body() noteDto: AddNoteDto) {
