...
interface AuthState {
  ...
  resetPassword: (password: string) => Promise<{ success: boolean; message: string; error?: string }>;
...
export const useAuthStore = create<AuthState>((set, get) => ({
  ...
  sendPasswordReset: async () => ({ success: false, message: 'Password recovery is not configured yet.' }),
  resetPassword: async () => ({ success: false, message: 'Password recovery is not configured yet.' }),
