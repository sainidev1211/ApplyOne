...
export default function ResetPassword() {
  ...
  const onSubmit = async (data: ResetPasswordInput) => {
    ...
    if (res.success) {
      toast.success('Your password has been reset. Please sign in.', 'Password Updated');
      navigate(ROUTES.LOGIN, { replace: true });
    } else {
      toast.error('Failed to reset password. Please request a new link.', 'Action Failed');
    }
  };
