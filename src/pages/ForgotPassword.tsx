...
export default function ForgotPassword() {
  ...
  const onSubmit = async (data: ForgotPasswordInput) => {
    ...
    if (res.success) {
      toast.success(res.message || 'Password reset email sent successfully.', 'Reset Email Sent');
      reset();
    } else {
      toast.error('Could not send reset link. Please check your email.', 'Action Failed');
    }
  };
