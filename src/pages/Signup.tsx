    ...
    <>
      ...
      <div className="space-y-6 text-left">
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-text-secondary-light dark:text-text-secondary-dark">Fill in your details to get started.</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              <label className="block text-sm font-medium text-text-primary-light dark:text-text-primary-dark">Account Type</label>
              <select className="w-full h-10 rounded-lg border border-border-light dark:border-border-dark bg-white dark:bg-card-dark text-text-primary-light dark:text-text-primary-dark px-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary" {...register('accountType')}>
        ...
        <p className="text-center text-sm text-text-secondary-light dark:text-text-secondary-dark pt-2">
          Already have an account? <Link to={ROUTES.LOGIN} className="font-semibold text-primary hover:underline">Sign in</Link>
        </p>
      </div>
    </>
  );
